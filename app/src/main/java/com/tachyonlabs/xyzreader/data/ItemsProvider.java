...
public class ItemsProvider extends ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		final com.tachyonlabs.xyzreader.data.SelectionBuilder builder = buildSelection(uri);
	...
	private com.tachyonlabs.xyzreader.data.SelectionBuilder buildSelection(Uri uri) {
		final com.tachyonlabs.xyzreader.data.SelectionBuilder builder = new com.tachyonlabs.xyzreader.data.SelectionBuilder();
		final int match = sUriMatcher.match(uri);
		return buildSelection(uri, match, builder);
	}

	private com.tachyonlabs.xyzreader.data.SelectionBuilder buildSelection(Uri uri, int match, com.tachyonlabs.xyzreader.data.SelectionBuilder builder) {
